...
var Users = []User{
	{
		...
		UserPhone: "+1234567890", EncodedPassword: "encrypted_password", Nickname: "Ann",
	...
	},
	{
		...
		UserPhone: "+134562897", EncodedPassword: "encrypted_password2", Nickname: "Johnny",
...
var Comments = []Comment{
	{CommentID: 1, PosterID: 101, Comment: "not bad", ProductID: 201},
	{CommentID: 2, PosterID: 101, Comment: "pretty good", ProductID: 201},
}
...
var Posts = []Post{
	{
		PostID: uuid.New(), Title: "Vintage Vase", Description: "A beautiful antique vase from the 19th century.",
	...
	{
		PostID: uuid.New(), Title: "Classic Clock", Description: "An elegant wall clock from the early 20th century.",
